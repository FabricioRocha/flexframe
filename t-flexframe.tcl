...
flexframe .left.vf -orient vertical -spacing 2 -minpad 1 -start nw -autoscroll 0 -center 1
...
flexframe .right.hf -orient horizontal -spacing 2 -minpad 1 -start nw -autoscroll 1 -center 0
